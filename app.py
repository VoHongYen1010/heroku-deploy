...
cred = credentials.Certificate("iuh-20089301-71f0f-firebase-adminsdk-vw0tn-b9f9be7cc6.json")
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20089301').stream())
    ...
    children=[
        html.Div(
            children=[
                ...
                html.H1(children="Võ Hồng Yến - 20089301-DHHTTT16B" ,className="header-title")
            ],
            className="header"
        ),
        html.Div(
